...
function Checkout() {
  ...
  const unitPix = 99.90;
  const unitFull = 149.00;
  const shipping = 29.94;
    ...
    <div className="min-h-screen bg-[#f5f5f5] mx-auto max-w-[480px] pb-24">
      ...
      <div className="bg-white mt-2 px-4 py-3">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="font-medium">ABSHOPCOM</span>
        </div>
        <div className="flex gap-3">
          <img src={drumImg} alt="" className="w-20 h-20 object-cover rounded bg-gray-100 shrink-0"/>
          <div className="flex-1">
            <div className="text-sm text-gray-700 leading-snug">Bateria Eletrônica Musical 9 Pads 6 Drums 5...</div>
            <div className="mt-2 flex items-baseline gap-1">
              <span className="text-[#ee4d2d] font-semibold text-sm">R$</span>
              <span className="text-[#ee4d2d] text-xl font-bold">99,90</span>
              <span className="text-[#ee4d2d] text-xs">no Pix</span>
            </div>
            <div className="text-[11px] text-gray-500">ou R$149,00 em outros métodos</div>
          </div>
      ...
      <div className="bg-white mt-2 px-4 py-3">
        ...
        <div className="border border-[#26aa99] rounded-md bg-[#f0faf8] p-3 relative overflow-hidden">
          ...
          <div className="flex justify-between">
            ...
            <div className="font-medium">{brl(shipping)}</div>
          </div>
          <div className="text-xs text-gray-600 mt-1">Chega entre 1 e 5/jun</div>
        </div>
      </div>
      ...
      <div className="bg-white mt-2 px-4 py-3 text-sm">
        ...
        <Row label="Total do Frete" v={brl(shipping)}/>
